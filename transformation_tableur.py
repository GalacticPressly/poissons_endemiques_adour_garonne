...
# parametres a modifier pour chaque fichier
NOM_FICHIER_ENTREE = "FD19_2021_.csv"
NOM_FICHIER_SORTIE = "FD19_2021.csv"
COLONNE_1 = 16 # numero de la premiere colonne avec un code sandre
COLONNE_2 = 22 # numero de la derniere colonne avec un code sandre
SEPARATEUR = ";" # separateur du fichier csv
COL_COORD_X = 5 # numero de la colonne des coordonnees x
COL_COORD_Y = 6 # numero de la colonne des coordonnees x
COL_DATE = 3 # numero de la colonne de la date
